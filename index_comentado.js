// Importa o array de livros do arquivo "array.js"
...
function mergeSort(array) {
  ...
  if (array.length > 1) {
    ...
    // Junta as duas partes ordenadas usando a função 'ordena'
...
function ordena(part1, part2) {
  ...
  while (
    ...
    // Pega o produto atual da segunda parte
    ...
    if (produtoAtualPart1.preco < produtoAtualPart2.preco) {
      ...
      // Caso contrário, adiciona o produto da segunda parte ao resultado
  ...
  // Adiciona os elementos restantes da parte que ainda não terminou
